    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                My favourite Recipe (Butter Chicken):
                <ol id="wd-your-favorite-recipe">
                    <li>Marinate: Coat chicken with spices and ginger-garlic paste.</li>
                    <li>Cook Chicken: Brown chicken in butter until partially cooked.</li>
                    <li>Make Sauce: Cook tomato puree with spices and butter.</li>
                    <li>Combine: Add chicken, cream, simmer until fully cooked.</li>
                    <li>Serve: Garnish with coriander, serve with rice or naan.</li>
                </ol>
            ...
            <div id="wd-images">
                ...
                <br />
                <Image id="wd-teslabot" src="/images/teslabot.jpg" height={200} width={400} alt="teslabot"/>
            </div>
